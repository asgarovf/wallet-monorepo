...
library FCL_Elliptic_ZZ {
    ...
    function ecZZ_SetZero()
        internal
        pure
        returns (uint x, uint y, uint zz, uint zzz)
    {
        return (0, 0, 0, 0);
    }
    ...
    function ecZZ_mulmuladd_S_asm(
        uint Q0,
        uint Q1, // Point G and Q stored in one memory for stack optimization
        uint scalar_u,
        uint scalar_v
